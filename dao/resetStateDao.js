...
module.exports = {
    ...
    async resetStateFlow(stateNumber, userID, password) {
        ...
        const responseState = await I.sendPostRequest(secret("https://staging-smb-user.otoku.io/api/v1/user/account-creation/set?step=" + stateNumber));
    ...
    async getTokenLogin(userID, password) {
        ...
        const responseLogin = await I.sendPostRequest("https://staging-smb-user.otoku.io/api/v1/user/login", secret({
            userID: userID,
            password: password,
        }));
    ...
    async getProductType(userID, password){
        ...
        const responseProfile = await I.sendGetRequest(secret("https://staging-smb-user.otoku.io/api/v1/user/profile"));
        I.seeResponseCodeIsSuccessful();
    ...
    async getAccountNumber(userID, password){
        ...
        const responseBusinessDetails = await I.sendGetRequest(secret("https://staging-smb-user.otoku.io/api/v1/user/business/details"));
        I.seeResponseCodeIsSuccessful();
