...
declare namespace CodeceptJS {
  interface SupportObject { I: I, current: any, registrationPage: registrationPage, optConfirmationPage: optConfirmationPage, loginPage: loginPage, welcomePage: welcomePage }
