...
Feature: Select the Anchor
    As a customer lead
    I want to select the anchor AR
...
#    @C83808 @LoanApp
    Scenario: User validate error field on form another anchor
        ...
        And user should see error "Nama buyer wajib diisi" in the below of field "buyerNameField"
