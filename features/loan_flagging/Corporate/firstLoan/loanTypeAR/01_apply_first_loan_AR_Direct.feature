Feature: Apply First Loan With Flagging Corporate Using AR Direct
 As a customer lead
 I want to apply first loan using AR Direct with Corporate has flag
 ...
 Scenario: User apply first loan AR direct type with flagging Corporate
