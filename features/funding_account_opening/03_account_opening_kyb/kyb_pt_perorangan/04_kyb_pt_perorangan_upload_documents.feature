Feature: Account Opening KYB PT Perorangan - Upload Document Business
    ...
    @C173116
    Scenario: Access widget brankas document in upload document business PT Perorangan
    ...
    Scenario: Upload only document required business type PT Perorangan   
        Given I am a customer that recently registered to amarbank business with data as below
            | fullName        | Testing                        |
            | email           | acc_op_pt_perorangan@gmail.com |
        ...
        And I click button progress upload document
        And I will see all document required business individual company has been uploaded
        And I will see button request account opening is shown
