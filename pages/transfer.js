...
module.exports = {
  ...
  texts: {
    ...
    adminFeeSKN: "~feeSKN",
    titleActiveSaldo: { xpath: '//android.widget.TextView[@text="Saldo aktif"]' },
    titleAmountTransfer: { xpath: '//android.widget.ScrollView/android.widget.TextView[@text="Nominal Transfer"]' },
