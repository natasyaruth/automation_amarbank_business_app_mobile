...
Feature: Loan Disbursement for Loan Type PO
  ...
  Scenario: Validate page Loan Program Information for type PO and LTV is 100%
    Given I have been on Loan Dashboard to checking if anchor already upload invoice
    When I click button "Gunakan Limit" in card type Loan PO
    And I am on Anchor Detail Page
    And I click "Info Selengkapnya" in limit card for type PO
    Then I should be see Program Loan Information for type PO

  @FunctTestLendingSprint6
  Scenario: Validate page Loan Program Information for type PO and LTV < 100%
    Given I have been on Loan Dashboard to checking if anchor already upload invoice
    When I click button "Gunakan Limit" in card type Loan PO
    And I am on Anchor Detail Page
    And I click button "Info Selengkapnya" for type PO
    Then I should be see Program Loan Information for type PO below 100
