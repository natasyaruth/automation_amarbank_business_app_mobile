Feature: Apply Loan With Flagging Corporate Using AP Direct After Registration Giro Account
 As a customer lead
 I want to apply loan using AP Direct with Corporate has flag after registration giro account
 ...
 Scenario: User apply loan AP direct type with flagging Corporate after registration giro account
