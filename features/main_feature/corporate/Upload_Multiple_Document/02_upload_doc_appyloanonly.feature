Feature: File Upload and Size Validation fpr Loan Type Corp
 As a customer lead
 I want to apply second loan  with flaging Corp and MSME
...
Scenario: User upload files and validate its size for Second Loan Type AP PT.Perusahaan Corp
...
Scenario: User upload files and validate its size for Second Loan Type AR PT.Perusahaan Corp
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type AP PT.Perorangan or UD Corp
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for second Loan Type AR PT.Perorangan or UD Corp
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type AR Individu Corp
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
#MSME
Scenario: User upload files and validate its size for Second Loan Type AP PT.Perusahaan MSME
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type AR PT.Perusahaan MSME
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type PO PT.Perusahaan MSME
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type AP PT.Perorangan or UD MSME
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type AR PT.Perorangan or UD MSME
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type PO PT.Perorangan or UD MSME
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type AP Individu Corp MSME
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User upload files and validate its size for Second Loan Type PO Individu MSME
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User successfully upload document second loan PO MSME PT.Perusahaan
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User successfully upload document second loan AR MSME Individu
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
...
Scenario: User successfully upload document second loan AP MSME Individu
  Given user already apply loan but have no upload document
  When user click from Aktivitas pinjaman
  And user on Aktivitas Pinjaman Page
  And user click loan with status Pengajuan Limit & Upload Dokumen
