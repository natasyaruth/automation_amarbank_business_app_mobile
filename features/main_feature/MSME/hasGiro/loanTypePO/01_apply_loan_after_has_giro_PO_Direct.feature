Feature: Apply Loan With Flagging MSME Using PO Direct After Registration Giro Account
 As a customer lead
 I want to apply loan using PO Direct with MSME has flag after registration Giro Account
 ...
 Scenario: User apply loan PO direct type with flagging MSME after registration giro account
