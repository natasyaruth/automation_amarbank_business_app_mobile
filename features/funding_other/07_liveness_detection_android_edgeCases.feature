Feature: Edge Cases SDK Active Liveness Integration for Android App
    ...
    Scenario: Successfully perform liveness verification and save transaction
        ...
        When the Liveness ID is used to hit POST API "active-liveness/abadi/advanceaisdk/android/store/v1"
    ...
    Scenario: User denies camera permission
        ...
        Then the SDK returns a result event "CAMERA_PERMISSION_DENIED"
    ...
    Scenario: API fails to return TransactionID due to invalid Liveness ID
        ...
        When the Liveness ID is invalid and is used to hit POST API "active-liveness/abadi/advanceaisdk/android/store/v1"
