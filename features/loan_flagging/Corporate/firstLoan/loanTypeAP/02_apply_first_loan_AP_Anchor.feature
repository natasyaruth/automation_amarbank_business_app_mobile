Feature: Apply First Loan With Flagging Corporate Using AP Anchor
 As a customer lead
 I want to apply first loan using AP Anchor with Corporate has flag
 ...
 Scenario: User apply first loan AP anchor type with flagging Corporate
