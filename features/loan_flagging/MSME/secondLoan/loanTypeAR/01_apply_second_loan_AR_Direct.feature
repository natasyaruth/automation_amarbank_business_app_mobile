Feature: Apply Second Loan With Flagging MSME Using AR Direct
 As a customer lead
 I want to apply second loan using AR Direct with MSME has flag
 ...
 Scenario: User apply second loan AR direct type with flagging MSME
