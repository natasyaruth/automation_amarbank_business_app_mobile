...
module.exports = {
  ...
  buttons: {
    ...
    refresh: "~buttonRefresh",
    deleteNIB: "~button1",
    deleteAktaBusiness: "~button2",
    deleteNPWPBusiness: "~button5",
    deleteAkta: "~button7",
    deleteSKBusiness: "~button7",
    deleteSK: "~button6",
    deleteLastCertificateBusiness: "~button4",
    deleteLastCertificate: "~button9",
    deleteLastSk: "~button10",
    deleteLastSkBusiness: "~button9",
  ...
  texts: {
    sizeDocumentNIB: "~sizeSource1",
    sizeDocumentAktaBusiness: "~sizeSource2",
    sizeDocumentAkta: "~sizeSource7",
    sizeDocumentSK: "~sizeSource6",
    sizeDocumentSKBusiness: "~sizeSource7",
    sizeDocumentNPWPBusiness: "~sizeSource5",
    sizeDocumentNPWP: "~sizeSource5",
    sizeDocumentLastCertificate: "~sizeSource9",
    sizeDocumentLastCertificateBusiness: "~sizeSource4",
    sizeDocumentLastSk: "~sizeSource10",
    sizeDocumentLastSkBusiness: "~sizeSource9",
  },
  messageError: {
