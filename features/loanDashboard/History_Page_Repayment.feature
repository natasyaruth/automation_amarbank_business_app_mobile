Feature: History Page Repayment
    ...
    Scenario: Access History Page Repayment For Semua Status
        Given I have been acces history repayment to see "Pilih Status"
