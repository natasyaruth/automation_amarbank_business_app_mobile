Feature: Apply Loan With Flagging Corporate Using AP Anchor After Registration Giro Account
 As a customer lead
 I want to apply loan using AP Anchor with Corporate has flag after registration Giro Account
 ...
 Scenario: User apply loan AP anchor type with flagging Corporate after registration giro account
