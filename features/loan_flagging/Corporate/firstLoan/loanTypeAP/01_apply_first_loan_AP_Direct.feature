Feature: Apply First Loan With Flagging Corporate Using AP Direct
 As a customer lead
 I want to apply first loan using AP Direct with Corporate has flag
 ...
 Scenario: User apply first loan AP direct type with flagging Corporate
