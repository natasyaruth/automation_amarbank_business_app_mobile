Feature: Apply Loan With Flagging MSME Using AP Direct After Registration Giro Account
 As a customer lead
 I want to apply loan using AP Direct with MSME has flag after registration Giro Account
 ...
 Scenario: User apply loan AP direct type with flagging MSME after registration giro account
