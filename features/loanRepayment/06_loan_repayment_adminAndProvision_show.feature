...
Scenario: Accessing "Lihat Detail" to See The Payment Info From Any Loan Tipe with Status Success
    ...
    Then I should be see the payment info from loan type AP or Direct AP or PO or AR in status
 ...
 Scenario: Validate Bill Information With Type Loan AP
    ...
    And I see Biaya Admin
    And I see Biaya Provisi

Scenario: Validate Bill Information With Type Loan AP Direct
    Given I have been on history card "Tagihan" with filter "Sedang Berjalan" to see bill information with status success
    When I access the detail
    And I should be see the loan type AP
    And I see Biaya Admin
...
Scenario: Validate Bill Information With Type Loan AR
    Given I have been on history card "Tagihan" with filter "Sedang Berjalan" to see bill information with status success
    When I access the detail
    And I should be see the loan type AP
    And I see Biaya Admin
...
Scenario: Validate Bill Information With Type Loan AR Direct
    Given I have been on history card "Tagihan" with filter "Sedang Berjalan" to see bill information with status success
    When I access the detail
    And I should be see the loan type AP
    And I see Biaya Admin
