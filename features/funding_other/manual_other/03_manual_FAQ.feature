Feature: FAQ
    ...
    Scenario: Checking content FAQ related to user management   
        Given I am a customer that want know more about Amar Bank Business
        When I login to app
        And I click menu Lainnya
        And I click menu FAQ
        And I click option setting user access
        And I click question about how to add new user as staff
        Then I will see information contain with procedure to add new user