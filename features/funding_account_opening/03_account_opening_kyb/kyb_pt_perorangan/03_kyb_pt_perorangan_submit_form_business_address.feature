...
Feature: Account Opening KYB PT Perorangan - Submit Business Address
    ...
    Background: User choose legality business type PT Perorangan
        Given I am a registered customer with following details:
            | userID   | ptpe5040                        |
            | password | 1234Test                        |
            | email    | pt_perorangan120@trash-mail.com |
        ...
        And I fill all information identity details as followings:
            | eKtpNumber    | 3175055912900005                  |
            | fullName      | PT PERORANGAN INTEGRATE DUA PULUH |
            | placeOfBirth  | MEDAN                             |
        ...
        And I fill my business profile as followings:
            | businessName      | PT PERORANGAN INTEGRATE DUA PULUH |
            | industry          | Jasa                              |
