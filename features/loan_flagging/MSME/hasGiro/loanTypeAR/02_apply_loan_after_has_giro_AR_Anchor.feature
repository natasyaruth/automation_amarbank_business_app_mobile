Feature: Apply Loan With Flagging MSME Using AR Anchor After Registration Giro Account
 As a customer lead
 I want to apply loan using AR Anchor with MSME has flag after registration Giro Account
 ...
 Scenario: User apply loan AR anchor type with flagging MSME after registration giro account
